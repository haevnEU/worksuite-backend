...
public class AboutService {
    ...
    public AboutSystemInfoResponse getSystemInfo() {
        ...
        final Map<String, String> serviceHealth = Map.of(
            "database", postgresInfo != null && "UP".equals(postgresInfo.status()) ? "UP" : "DOWN",
            "mongo", mongoInfo != null && "UP".equals(mongoInfo.status()) ? "UP" : "DOWN",
            "vcsGateway", "UP",
            "redmineGateway", "UP"
        );

        return new AboutSystemInfoResponse(
            appName,
            appVersion,
            gitCommit,
            activeProfile,
        ...
        try {
            return CompletableFuture.supplyAsync(() -> {
                try (Connection connection = dataSource.getConnection()) {
                    ...
                    final String cleanUrl = rawUrl != null ? rawUrl.replaceAll("(?i)(password=)[^;&]*", "$1*****") : "N/A";
        ...
        try {
            return CompletableFuture.supplyAsync(() -> {
                ...
                return new DatabaseInfo(
                    ...
                    pingResult.containsKey("ok") ? "UP" : "DOWN",
                    pingMs,
                    0,
                    0,
                    0
