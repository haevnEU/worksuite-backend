...
@Component
public class RetroBeforeConvertCallback implements BeforeConvertCallback<RetroModel> {

    @Override
    public RetroModel onBeforeConvert(final RetroModel entity, final String collection) {
